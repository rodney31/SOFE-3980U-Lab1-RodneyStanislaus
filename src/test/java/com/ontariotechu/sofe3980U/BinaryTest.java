...
public class BinaryTest 
{
    ...
    {
        Binary binary1=new Binary("01111");
        Binary binary2=new Binary("0");
    ...
    /**
     * Test The bitwiseOR function with values of different length
     */
    @Test
    public void bitwiseOR3()
    {
        Binary binary1=new Binary("011");
    ...
    /**
     * Test The bitwiseAND function with values of different length
     */
    @Test
    public void bitwiseAND3()
    {
        Binary binary1=new Binary("100000110");
    ...
    {
        Binary binary1=new Binary("0100100");
        Binary binary2=new Binary("1110101");
        Binary binary3=Binary.multiply(binary1,binary2);
        assertTrue( binary3.getValue().equals("1000001110100"));
    }
    /**
     * Test The multiply function with values of different length
     */
    @Test
    public void multiply3()
    {
        Binary binary1=new Binary("1011");
        Binary binary2=new Binary("101011101");
        Binary binary3=Binary.multiply(binary1,binary2);
        assertTrue( binary3.getValue().equals("111011111111"));
    }
}
